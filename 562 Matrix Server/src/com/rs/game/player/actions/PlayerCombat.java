...
public class PlayerCombat extends Action {
	...
	public int mageAttack(final Player player, int spellId, boolean autocast) {
		...
		if (spellId == 65535) {
			...
			mage_hit_gfx = 2036;
			delayMagicHit(2,
					getMagicHit(player, getRandomMagicMaxHit(player, (5 * player.getSkills().getLevel(Skills.MAGIC)) - 18)));
		...
		if (player.getCombatDefinitions().getSpellBook() == 192) {
			switch (spellId) {
			case 25: // air strike
				//player.setNextGraphics(new Graphics(90));
				player.setNextGraphics(new Graphics(90, 0, 100));
				player.setNextAnimation(new Animation(1162));
				mage_hit_gfx = 92;
				base_mage_xp = 5.5;
				int baseDamage = 2;
				...
				World.sendProjectile(player, target, 91, 46, 31, 50, 50, 0, 0);//18, 18, 50, 50, 0, 0);
				return 5;
			case 28: // water strike
				...
				World.sendProjectile(player, target, 94, 46, 31, 50, 50, 0, 0);
				return 5;
			case 36:// bind
				...
				Hit magicHit = getMagicHit(player,
						getRandomMagicMaxHit(player, 2));
				delayMagicHit(2, magicHit);
				World.sendProjectile(player, target, 178, 46, 31, 50, 50, 0, 0);
			...
			case 30: // earth strike
				player.setNextGraphics(new Graphics(96, 0, 100));
				player.setNextAnimation(new Animation(1162));
				mage_hit_gfx = 98;
				base_mage_xp = 9.5;
				baseDamage = 6;
				...
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, baseDamage)));
				World.sendProjectile(player, target, 97, 46, 31, 50, 50, 0, 0);
				return 5;
			case 32: // fire strike
				...
				World.sendProjectile(player, target, 100, 46, 31, 50, 50, 0, 0);
				return 5;
			case 34: // air bolt
				...
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, baseDamage)));
				World.sendProjectile(player, target, 118, 46, 31, 50, 50, 0, 0);
				return 5;
			case 39: // water bolt
				...
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, baseDamage)));
				World.sendProjectile(player, target, 121, 46, 31, 50, 50, 0, 0);
				return 5;
			case 42: // earth bolt
				...
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, baseDamage)));
				World.sendProjectile(player, target, 124, 46, 31, 50, 50, 0, 0);
				return 5;
			case 45: // fire bolt
				...
				delayMagicHit(2, getMagicHit(player, damage));
				World.sendProjectile(player, target, 127, 46, 31, 50, 50, 0, 0);
				return 5;
			case 49: // air blast
				...
				base_mage_xp = 25.5;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 13)));
				World.sendProjectile(player, target, 133, 46, 31, 50, 50, 0, 0);
				return 5;
			case 52: // water blast
				...
				base_mage_xp = 31.5;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 14)));
				World.sendProjectile(player, target, 136, 46, 31, 50, 50, 0, 0);
				return 5;
			case 58: // earth blast
				...
				base_mage_xp = 31.5;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 15)));
				World.sendProjectile(player, target, 139, 46, 31, 50, 50, 0, 0);
				return 5;
			case 63: // fire blast
				...
				mage_hit_gfx = 131;
				base_mage_xp = 34.5;
				damage = getRandomMagicMaxHit(player, 16);
				if (target instanceof NPC) {
					NPC n = (NPC) target;
					if (n.getId() == 9463) // ice verm
						damage *= 2;
			...
			case 66:// Saradomin Strike
				...
				base_mage_xp = 34.5;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 30)));
				return 5;
			...
			case 68: // Flames of Zamorak
				...
				return 5;
			case 70: // air wave
				player.setNextGraphics(new Graphics(158, 0, 100));
				player.setNextAnimation(new Animation(1162));
				mage_hit_gfx = 160;
				base_mage_xp = 36;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 17)));
				World.sendProjectile(player, target, 159, 46, 31, 50, 50, 0, 0);
				return 5;
			case 73: // water wave
				player.setNextGraphics(new Graphics(161, 0, 100));
				player.setNextAnimation(new Animation(1162));
				mage_hit_gfx = 163;
				base_mage_xp = 37.5;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 18)));
				World.sendProjectile(player, target, 162, 46, 31, 50, 50, 0, 0);
				return 5;
			case 77: // earth wave
				player.setNextGraphics(new Graphics(164, 0, 100));
				player.setNextAnimation(new Animation(1162));
				mage_hit_gfx = 166;
				base_mage_xp = 42.5;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 19)));
				World.sendProjectile(player, target, 165, 46, 31, 50, 50, 0, 0);
				return 5;
			case 80: // fire wave
				player.setNextGraphics(new Graphics(155, 0, 100));
				player.setNextAnimation(new Animation(1162));
				mage_hit_gfx = 157;
				base_mage_xp = 42.5;
				damage = getRandomMagicMaxHit(player, 20);
				if (target instanceof NPC) {
					NPC n = (NPC) target;
					if (n.getId() == 9463) // ice verm
						damage *= 2;
				...
				delayMagicHit(2, getMagicHit(player, damage));
				World.sendProjectile(player, target, 156, 46, 31, 50, 50, 0, 0);
				return 5;
			case 86: // teleblock
				if (target instanceof Player
				...
				return 5;
			case 84:// air surge
				player.setNextGraphics(new Graphics(457, 0, 100));
				player.setNextAnimation(new Animation(10546));
				mage_hit_gfx = 2700;
				base_mage_xp = 80;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 220)));
				World.sendProjectile(player, target, 462, 46, 31, 50, 50, 0, 0);
				return 5;
			case 87:// water surge
				player.setNextGraphics(new Graphics(2701, 0, 100));
				...
				return 5;
			case 89:// earth surge
				player.setNextGraphics(new Graphics(2717, 0, 100));
				player.setNextAnimation(new Animation(14209));
				mage_hit_gfx = 2727;
				base_mage_xp = 80;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 260)));
				World.sendProjectile(player, target, 2722, 46, 31, 50, 50, 0, 0);
				return 5;
			case 91:// fire surge
				player.setNextGraphics(new Graphics(2728, 0, 100));
			...
			case 32:// Shadow Rush
				...
				reduceAttack = true;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 16)));
			...
			case 36: //Miasmic rush
				...
				mage_hit_gfx = 1847;
				base_mage_xp = 35;
				delayMagicHit(2, getMagicHit(player, getRandomMagicMaxHit(player, 20)));
			...
			case 37: //Miasmic blitz
				...
				mage_hit_gfx = 1851;
				base_mage_xp = 48;
				delayMagicHit(2, getMagicHit(player, getRandomMagicMaxHit(player, 28)));
			...
			case 38: //Miasmic burst
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						mage_hit_gfx = 1849;
						base_mage_xp = 42;
						int damage = getRandomMagicMaxHit(player, 24);
						delayMagicHit(2, getMagicHit(player, damage));
						if (target.getTemporaryAttributtes().get("miasmic_immunity") != Boolean.TRUE) {
							if (target instanceof Player) {
								((Player) target).getPackets().sendGameMessage("You feel slowed down.");
			...
			case 39: //Miasmic barrage
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						mage_hit_gfx = 1854;
						base_mage_xp = 54;
						int damage = getRandomMagicMaxHit(player, 32);
						delayMagicHit(2, getMagicHit(player, damage));
						if (target.getTemporaryAttributtes().get("miasmic_immunity") != Boolean.TRUE) {
							if (target instanceof Player) {
								((Player) target).getPackets().sendGameMessage("You feel slowed down.");
			...
			case 30:// Smoke burst
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 36;
						max_poison_hit = 20;
						int damage = getRandomMagicMaxHit(player, 19);
						delayMagicHit(2, getMagicHit(player, damage));
			...
			case 34:// Shadow burst
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 37;
						reduceAttack = true;
						int damage = getRandomMagicMaxHit(player, 20);
						delayMagicHit(2, getMagicHit(player, damage));
						if(!nextTarget) {
							if(damage == -1)
								return false;
			...
			case 26:// Blood burst
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 39;
						blood_spell = true;
						int damage = getRandomMagicMaxHit(player, 21);
						delayMagicHit(2, getMagicHit(player, damage));
						if(!nextTarget) {
							if(damage == -1)
								return false;
			...
			case 22:// Ice burst
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						freeze_time = 15000;
						magic_sound = 169;
						int damage = getRandomMagicMaxHit(player, 22);
			...
			case 29:// Smoke Blitz
				...
				max_poison_hit = 40;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 23)));
				World.sendProjectile(player, target, 386, 18, 18, 50, 50, 0, 0);
				return 4;
			case 33:// Shadow Blitz
				...
				reduceAttack = true;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 24)));
				World.sendProjectile(player, target, 380, 18, 18, 50, 50, 0, 0);
				return 4;
			case 25:// Blood Blitz
				player.setNextAnimation(new Animation(1978));
				...
				blood_spell = true;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 25)));
				World.sendProjectile(player, target, 374, 18, 18, 50, 50, 0, 0);
				return 4;
			case 21:// Ice Blitz
				player.setNextGraphics(new Graphics(366));
				...
				magic_sound = 169;
				delayMagicHit(2,
						getMagicHit(player, getRandomMagicMaxHit(player, 26)));
			...
			case 31:// Smoke barrage
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 48;
						max_poison_hit = 40;
						int damage = getRandomMagicMaxHit(player, 27);
						delayMagicHit(2, getMagicHit(player, damage));
			...
			case 35:// shadow barrage
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 49;
						reduceAttack = true;
						int damage = getRandomMagicMaxHit(player, 28);
						delayMagicHit(2, getMagicHit(player, damage));
						if(!nextTarget) {
							if(damage == -1)
								return false;
			...
			case 27:// blood barrage
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 51;
						max_poison_hit = 40;
						int damage = getRandomMagicMaxHit(player, 29);
						delayMagicHit(2, getMagicHit(player, damage));
						World.sendProjectile(player, target, 390, 18, 18, 50, 50, 0, 0);
						if(!nextTarget) {
							if(damage == -1)
			...
			case 23: // ice barrage
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 52;
						int damage = getRandomMagicMaxHit(player, 30);
				...
				if (hit > 0) {
					...
					WorldTasksManager.schedule(new WorldTask() {
						...
						public void run() {
							...
							if (damage > 5) {
								damage -= 5;
								finalTarget.applyHit(new Hit(player, 5,
								...
								if (combatXp > 0) {
									if (hit.getLook() == HitLook.RANGE_DAMAGE) {
										...
										if (weaponId != -1) {
											...
											if (name.contains("(p++)")) {
												if (Utils.getRandom(8) == 0)
													target.getPoison().makePoisoned(7);
											} else if (name.contains("(p+)")) {
												if (Utils.getRandom(8) == 0)
