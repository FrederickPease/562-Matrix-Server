...
public abstract class Familiar extends NPC implements Serializable {
	...
	public void sendMainConfigs() {
		...
		//owner.getPackets().sendIComponentText(662, 204, getSpecialName());
		//owner.getPackets().sendIComponentText(662, 205, getSpecialDescription());
		owner.getPackets().sendConfig(1436,
	...
	public void sendFollowerDetails() {
		...
		owner.getInterfaceManager().sendTab(92,662);
