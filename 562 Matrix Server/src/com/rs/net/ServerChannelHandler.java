...
public final class ServerChannelHandler extends SimpleChannelHandler {
	...
	private ServerChannelHandler() {
		...
		bootstrap = new ServerBootstrap(new NioServerSocketChannelFactory(CoresManager.serverChannelExecutor, CoresManager.serverChannelExecutor, CoresManager.serverChannelExecutorThreadsCount-1));
